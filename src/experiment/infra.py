...
class ExperimentInfra:
    ...
    def cached_stage(self, stage_name: str) -> Callable[[Callable[..., T]], Callable[..., T]]:
    ...
    def clean_cache(self, keep_recent: int = 5) -> int:
        ...
        # Group files by type
        file_types = {
            "models": list(self.cache_dir.glob("*.pt")) + list(self.cache_dir.glob("*.pkl")),
